...
public class CacheRenderer {
  ...
  public CacheRenderer addSide(ForgeDirection face, IIcon[] icons, boolean inside) {
    return addSide(face, icons, inside, null);
  }

  public CacheRenderer addSide(ForgeDirection face, IIcon[] icons, boolean inside, BoundingBox tex_bb) {
    IIcon tex = icons[face.ordinal()];
    addSide(face, tex, inside, tex_bb);
    return this;
  }

  public CacheRenderer addSide(ForgeDirection face, IIcon tex, boolean inside) {
    return addSide(face, tex, inside, null);
  }

  public CacheRenderer addSide(ForgeDirection face, IIcon tex, boolean inside, BoundingBox tex_bb) {
    if (tex != null) {
      if (tex_bb != null) {
        ...
        minU = tex.getInterpolatedU(minU * 16f);
        maxU = tex.getInterpolatedU(maxU * 16f);
        minV = tex.getInterpolatedV(minV * 16f);
        maxV = tex.getInterpolatedV(maxV * 16f);
  ...
  public void addSkirt(IIcon[] icons, boolean inside, BoundingBox tex_bb) {
    addSides(AROUND, icons, inside, tex_bb);
  }
  ...
  public void addSkirt(IIcon tex, boolean inside, BoundingBox tex_bb) {
    addSides(AROUND, tex, inside, tex_bb);
  }
  ...
  public void addAllSides(IIcon[] icons, boolean inside, BoundingBox tex_bb) {
    addSides(ForgeDirection.VALID_DIRECTIONS, icons, inside, tex_bb);
  }
  ...
  public void addAllSides(IIcon tex, boolean inside, BoundingBox tex_bb) {
    addSides(ForgeDirection.VALID_DIRECTIONS, tex, inside, tex_bb);
  }

  public void addSides(ForgeDirection[] sides, IIcon[] icons, boolean inside) {
    addSides(sides, icons, inside, null);
  }

  public void addSides(ForgeDirection[] sides, IIcon[] icons, boolean inside, BoundingBox tex_bb) {
    for (ForgeDirection face : sides) {
      addSide(face, icons, inside, tex_bb);
    }
  }

  public void addSides(ForgeDirection[] sides, IIcon tex, boolean inside) {
    addSides(sides, tex, inside, null);
  }

  public void addSides(ForgeDirection[] sides, IIcon tex, boolean inside, BoundingBox tex_bb) {
    for (ForgeDirection face : sides) {
      addSide(face, tex, inside, tex_bb);
    }
  }
  ...
  @Override
  public String toString() {
    return "CacheRenderer [brightnessPerSide=" + Arrays.toString(brightnessPerSide) + ", brightness_TL=" + brightness_TL
        + ", brightness_TR=" + brightness_TR + ", brightness_BL=" + brightness_BL + ", brightness_BR=" + brightness_BR
        + ", csr=" + csr + "]";
  }
